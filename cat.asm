...
main(int argc, char *argv[])
{
  ...
  2b:	e8 58 03 00 00       	call   388 <open>
...
00000090 <cat>:
{
  ...
  9d:	8d 76 00             	lea    0x0(%esi),%esi
    if (write(1, buf, n) != n) {
  a0:	b8 40 0b 00 00       	mov    $0xb40,%eax
  a5:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  a9:	89 44 24 04          	mov    %eax,0x4(%esp)
  ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  b4:	e8 af 02 00 00       	call   368 <write>
  b9:	39 d8                	cmp    %ebx,%eax
  bb:	75 2a                	jne    e7 <cat+0x57>
  while((n = read(fd, buf, sizeof(buf))) > 0) {
  bd:	b8 00 02 00 00       	mov    $0x200,%eax
  c2:	ba 40 0b 00 00       	mov    $0xb40,%edx
  c7:	89 44 24 08          	mov    %eax,0x8(%esp)
  cb:	89 54 24 04          	mov    %edx,0x4(%esp)
  cf:	89 34 24             	mov    %esi,(%esp)
  d2:	e8 89 02 00 00       	call   360 <read>
  d7:	83 f8 00             	cmp    $0x0,%eax
  da:	89 c3                	mov    %eax,%ebx
  dc:	7f c2                	jg     a0 <cat+0x10>
  if(n < 0){
  de:	75 21                	jne    101 <cat+0x71>
}
  ...
  e7:	b9 08 08 00 00       	mov    $0x808,%ecx
  ec:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  f0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f7:	e8 94 03 00 00       	call   490 <printf>
      exit();
  fc:	e8 47 02 00 00       	call   348 <exit>
    printf(1, "cat: read error\n");
 101:	c7 44 24 04 1a 08 00 	movl   $0x81a,0x4(%esp)
 108:	00 
 109:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 110:	e8 7b 03 00 00       	call   490 <printf>
    exit();
 115:	e8 2e 02 00 00       	call   348 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 668:	e9 7e fe ff ff       	jmp    4eb <printf+0x5b>
          s = "(null)";
 66d:	bb 40 08 00 00       	mov    $0x840,%ebx
        while(*s != 0){
 ...
 681:	a1 20 0b 00 00       	mov    0xb20,%eax
{
 ...
 6c7:	5b                   	pop    %ebx
  freep = p;
 6c8:	a3 20 0b 00 00       	mov    %eax,0xb20
}
 6cd:	5e                   	pop    %esi
 6ce:	5f                   	pop    %edi
 6cf:	5d                   	pop    %ebp
 ...
 6de:	72 ce                	jb     6ae <free+0x2e>
{
 ...
 701:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 704:	a3 20 0b 00 00       	mov    %eax,0xb20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 791:	e8 ea fe ff ff       	call   680 <free>
  return freep;
 796:	8b 15 20 0b 00 00    	mov    0xb20,%edx
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	b8 24 0b 00 00       	mov    $0xb24,%eax
 7d5:	ba 24 0b 00 00       	mov    $0xb24,%edx
    base.s.size = 0;
 7da:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 7dc:	a3 20 0b 00 00       	mov    %eax,0xb20
    base.s.size = 0;
 7e1:	b8 24 0b 00 00       	mov    $0xb24,%eax
    base.s.ptr = freep = prevp = &base;
 7e6:	89 15 24 0b 00 00    	mov    %edx,0xb24
    base.s.size = 0;
 7ec:	89 0d 28 0b 00 00    	mov    %ecx,0xb28
