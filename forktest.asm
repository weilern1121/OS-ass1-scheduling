...
{
  write(fd, s, strlen(s));
  d6:	c7 04 24 ca 04 00 00 	movl   $0x4ca,(%esp)
  dd:	e8 2e 01 00 00       	call   210 <strlen>
  e2:	ba ca 04 00 00       	mov    $0x4ca,%edx
...
{
  write(fd, s, strlen(s));
 139:	c7 04 24 a3 04 00 00 	movl   $0x4a3,(%esp)
 140:	bb a3 04 00 00       	mov    $0x4a3,%ebx
...
{
  write(fd, s, strlen(s));
 16a:	c7 04 24 b7 04 00 00 	movl   $0x4b7,(%esp)
 171:	e8 9a 00 00 00       	call   210 <strlen>
 176:	b9 b7 04 00 00       	mov    $0x4b7,%ecx
