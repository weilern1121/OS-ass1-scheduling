...
main(int argc, char *argv[])
{
  ...
  13:	b8 80 07 00 00       	mov    $0x780,%eax
  ...
  60:	c7 44 24 04 93 07 00 	movl   $0x793,0x4(%esp)
  67:	00 
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 a7 07 00 00       	mov    $0x7a7,%eax
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6f7:	76 37                	jbe    730 <malloc+0x90>
    ...
    if(p == freep)
 6f9:	39 05 3c 0a 00 00    	cmp    %eax,0xa3c
 ...
 719:	e8 e2 fe ff ff       	call   600 <free>
  return freep;
 71e:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 73f:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
      return (void*)(p + 1);
 ...
 754:	eb e9                	jmp    73f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	b8 40 0a 00 00       	mov    $0xa40,%eax
 75b:	ba 40 0a 00 00       	mov    $0xa40,%edx
    base.s.size = 0;
 760:	31 c9                	xor    %ecx,%ecx
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 762:	a3 3c 0a 00 00       	mov    %eax,0xa3c
    base.s.size = 0;
 767:	b8 40 0a 00 00       	mov    $0xa40,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 76c:	89 15 40 0a 00 00    	mov    %edx,0xa40
    base.s.size = 0;
 772:	89 0d 44 0a 00 00    	mov    %ecx,0xa44
