   ...
   a:	83 7d 08 03          	cmpl   $0x3,0x8(%ebp)
{
  ...
  13:	c7 44 24 04 58 07 00 	movl   $0x758,0x4(%esp)
  1a:	00 
  1b:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  22:	e8 b9 03 00 00       	call   3e0 <printf>
    exit();
  27:	e8 6c 02 00 00       	call   298 <exit>
  }
  ...
  39:	e8 ba 02 00 00       	call   2f8 <link>
  3e:	85 c0                	test   %eax,%eax
  40:	78 05                	js     47 <main+0x47>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  42:	e8 51 02 00 00       	call   298 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  47:	8b 43 08             	mov    0x8(%ebx),%eax
  4a:	89 44 24 0c          	mov    %eax,0xc(%esp)
  4e:	8b 43 04             	mov    0x4(%ebx),%eax
  51:	c7 44 24 04 6b 07 00 	movl   $0x76b,0x4(%esp)
  58:	00 
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b8:	e9 7e fe ff ff       	jmp    43b <printf+0x5b>
          s = "(null)";
 5bd:	bb 7f 07 00 00       	mov    $0x77f,%ebx
        while(*s != 0){
 ...
 5d1:	a1 14 0a 00 00       	mov    0xa14,%eax
{
 ...
 617:	5b                   	pop    %ebx
  freep = p;
 618:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 61d:	5e                   	pop    %esi
 61e:	5f                   	pop    %edi
 61f:	5d                   	pop    %ebp
 ...
 62e:	72 ce                	jb     5fe <free+0x2e>
{
 ...
 651:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 654:	a3 14 0a 00 00       	mov    %eax,0xa14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e1:	e8 ea fe ff ff       	call   5d0 <free>
  return freep;
 6e6:	8b 15 14 0a 00 00    	mov    0xa14,%edx
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 70f:	89 15 14 0a 00 00    	mov    %edx,0xa14
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	b8 18 0a 00 00       	mov    $0xa18,%eax
 725:	ba 18 0a 00 00       	mov    $0xa18,%edx
    base.s.size = 0;
 72a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 72c:	a3 14 0a 00 00       	mov    %eax,0xa14
    base.s.size = 0;
 731:	b8 18 0a 00 00       	mov    $0xa18,%eax
    base.s.ptr = freep = prevp = &base;
 736:	89 15 18 0a 00 00    	mov    %edx,0xa18
    base.s.size = 0;
 73c:	89 0d 1c 0a 00 00    	mov    %ecx,0xa1c
