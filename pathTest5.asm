...
_pathTest5:     file format elf32-i386
...
int main(int argc, char *argv[]){
   ...
   1:	b8 c4 08 00 00       	mov    $0x8c4,%eax
int main(int argc, char *argv[]){
   6:	89 e5                	mov    %esp,%ebp
   8:	53                   	push   %ebx
    args[0] = "/ln";
    ...
    args[2] = "/bin/cat";
   9:	bb 89 08 00 00       	mov    $0x889,%ebx
int main(int argc, char *argv[]){
  ...
  1f:	e8 bc 04 00 00       	call   4e0 <printf>
    args[0] = "/ln";
  24:	ba 75 08 00 00       	mov    $0x875,%edx
    args[1] = "/notIn/path/cat";
  29:	b9 79 08 00 00       	mov    $0x879,%ecx
    args[2] = "/bin/cat";
  ...
  8a:	c7 04 24 75 08 00 00 	movl   $0x875,(%esp)
    args[3] = 0;
  91:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    execute(command,args);
  95:	e8 26 00 00 00       	call   c0 <execute>

    printf(1,"exiting\n");
  9a:	ba b9 08 00 00       	mov    $0x8b9,%edx
...
void execute(char * command, char** args){
  ...
  c6:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  c9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  cc:	89 75 fc             	mov    %esi,-0x4(%ebp)
  cf:	8b 75 0c             	mov    0xc(%ebp),%esi
    int pid;

    if((pid = fork()) == 0){
  d2:	e8 99 02 00 00       	call   370 <fork>
  d7:	83 f8 00             	cmp    $0x0,%eax
  da:	74 3c                	je     118 <execute+0x58>
        exec(command, args);
        printf(1, "exec %s failed\n", command);
    }
    else if(pid > 0){
  dc:	7e 1a                	jle    f8 <execute+0x38>
        //printf(1,"waiting for exec of %s to finish\n",command);
        wait(null);
  de:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
    }
    else{
  ...
  e5:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  e8:	8b 75 fc             	mov    -0x4(%ebp),%esi
  eb:	89 ec                	mov    %ebp,%esp
  ed:	5d                   	pop    %ebp
        wait(null);
  ee:	e9 8d 02 00 00       	jmp    380 <wait>
  f3:	90                   	nop
  f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        printf(1,"fork failed\n");
  f8:	c7 45 0c 68 08 00 00 	movl   $0x868,0xc(%ebp)
}
  ff:	8b 5d f8             	mov    -0x8(%ebp),%ebx
        printf(1,"fork failed\n");
 102:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
 109:	8b 75 fc             	mov    -0x4(%ebp),%esi
 10c:	89 ec                	mov    %ebp,%esp
 10e:	5d                   	pop    %ebp
        printf(1,"fork failed\n");
 10f:	e9 cc 03 00 00       	jmp    4e0 <printf>
 114:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        exec(command, args);
 118:	89 74 24 04          	mov    %esi,0x4(%esp)
 11c:	89 1c 24             	mov    %ebx,(%esp)
 11f:	e8 8c 02 00 00       	call   3b0 <exec>
        printf(1, "exec %s failed\n", command);
 124:	b8 58 08 00 00       	mov    $0x858,%eax
 129:	89 5c 24 08          	mov    %ebx,0x8(%esp)
 12d:	89 44 24 04          	mov    %eax,0x4(%esp)
 131:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 138:	e8 a3 03 00 00       	call   4e0 <printf>
}
 13d:	8b 5d f8             	mov    -0x8(%ebp),%ebx
 140:	8b 75 fc             	mov    -0x4(%ebp),%esi
 143:	89 ec                	mov    %ebp,%esp
 145:	5d                   	pop    %ebp
 146:	c3                   	ret    
 ...
 44e:	84 db                	test   %bl,%bl
{
 ...
 479:	0f b6 92 28 09 00 00 	movzbl 0x928(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 6b8:	e9 7e fe ff ff       	jmp    53b <printf+0x5b>
          s = "(null)";
 6bd:	bb 20 09 00 00       	mov    $0x920,%ebx
        while(*s != 0){
 ...
 6d1:	a1 f4 0b 00 00       	mov    0xbf4,%eax
{
 ...
 717:	5b                   	pop    %ebx
  freep = p;
 718:	a3 f4 0b 00 00       	mov    %eax,0xbf4
}
 71d:	5e                   	pop    %esi
 71e:	5f                   	pop    %edi
 71f:	5d                   	pop    %ebp
 ...
 72e:	72 ce                	jb     6fe <free+0x2e>
{
 ...
 751:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 754:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 3f                	jae    800 <malloc+0x90>
    ...
    if(p == freep)
 7c1:	39 05 f4 0b 00 00    	cmp    %eax,0xbf4
 ...
 7e1:	e8 ea fe ff ff       	call   6d0 <free>
  return freep;
 7e6:	8b 15 f4 0b 00 00    	mov    0xbf4,%edx
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 80f:	89 15 f4 0b 00 00    	mov    %edx,0xbf4
}
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	b8 f8 0b 00 00       	mov    $0xbf8,%eax
 825:	ba f8 0b 00 00       	mov    $0xbf8,%edx
    base.s.size = 0;
 82a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 82c:	a3 f4 0b 00 00       	mov    %eax,0xbf4
    base.s.size = 0;
 831:	b8 f8 0b 00 00       	mov    $0xbf8,%eax
    base.s.ptr = freep = prevp = &base;
 836:	89 15 f8 0b 00 00    	mov    %edx,0xbf8
    base.s.size = 0;
 83c:	89 0d fc 0b 00 00    	mov    %ecx,0xbfc
