...
main(int argc, char **argv)
{
  ...
  28:	e8 e3 01 00 00       	call   210 <atoi>
  2d:	89 04 24             	mov    %eax,(%esp)
  30:	e8 83 02 00 00       	call   2b8 <kill>
  for(i=1; i<argc; i++)
  ...
  39:	e8 4a 02 00 00       	call   288 <exit>
    printf(2, "usage: kill pid...\n");
  3e:	c7 44 24 04 48 07 00 	movl   $0x748,0x4(%esp)
  45:	00 
  46:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  4d:	e8 7e 03 00 00       	call   3d0 <printf>
    exit();
  52:	e8 31 02 00 00       	call   288 <exit>
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
 ...
 33e:	84 db                	test   %bl,%bl
{
 ...
 369:	0f b6 92 64 07 00 00 	movzbl 0x764(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a8:	e9 7e fe ff ff       	jmp    42b <printf+0x5b>
          s = "(null)";
 5ad:	bb 5c 07 00 00       	mov    $0x75c,%ebx
        while(*s != 0){
 ...
 5c1:	a1 f4 09 00 00       	mov    0x9f4,%eax
{
 ...
 607:	5b                   	pop    %ebx
  freep = p;
 608:	a3 f4 09 00 00       	mov    %eax,0x9f4
}
 60d:	5e                   	pop    %esi
 60e:	5f                   	pop    %edi
 60f:	5d                   	pop    %ebp
 ...
 61e:	72 ce                	jb     5ee <free+0x2e>
{
 ...
 641:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 644:	a3 f4 09 00 00       	mov    %eax,0x9f4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d1:	e8 ea fe ff ff       	call   5c0 <free>
  return freep;
 6d6:	8b 15 f4 09 00 00    	mov    0x9f4,%edx
 ...
 70f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 710:	b8 f8 09 00 00       	mov    $0x9f8,%eax
 715:	ba f8 09 00 00       	mov    $0x9f8,%edx
    base.s.size = 0;
 71a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 71c:	a3 f4 09 00 00       	mov    %eax,0x9f4
    base.s.size = 0;
 721:	b8 f8 09 00 00       	mov    $0x9f8,%eax
    base.s.ptr = freep = prevp = &base;
 726:	89 15 f8 09 00 00    	mov    %edx,0x9f8
    base.s.size = 0;
 72c:	89 0d fc 09 00 00    	mov    %ecx,0x9fc
