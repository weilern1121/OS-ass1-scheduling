...
main(int argc, char *argv[])
{
  ...
  20:	ba 78 07 00 00       	mov    $0x778,%edx
  25:	b9 7a 07 00 00       	mov    $0x77a,%ecx
  ...
  4c:	c7 44 24 0c 7f 07 00 	movl   $0x77f,0xc(%esp)
  53:	00 
  54:	89 44 24 08          	mov    %eax,0x8(%esp)
  58:	c7 44 24 04 7a 07 00 	movl   $0x77a,0x4(%esp)
  5f:	00 
  60:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  67:	e8 94 03 00 00       	call   400 <printf>
  exit(0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d8:	e9 7e fe ff ff       	jmp    45b <printf+0x5b>
          s = "(null)";
 5dd:	bb 81 07 00 00       	mov    $0x781,%ebx
        while(*s != 0){
 ...
 5f1:	a1 18 0a 00 00       	mov    0xa18,%eax
{
 ...
 637:	5b                   	pop    %ebx
  freep = p;
 638:	a3 18 0a 00 00       	mov    %eax,0xa18
}
 63d:	5e                   	pop    %esi
 63e:	5f                   	pop    %edi
 63f:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 18 0a 00 00    	mov    0xa18,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 3f                	jae    720 <malloc+0x90>
    ...
    if(p == freep)
 6e1:	39 05 18 0a 00 00    	cmp    %eax,0xa18
 ...
 701:	e8 ea fe ff ff       	call   5f0 <free>
  return freep;
 706:	8b 15 18 0a 00 00    	mov    0xa18,%edx
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 72f:	89 15 18 0a 00 00    	mov    %edx,0xa18
}
 ...
 73f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 740:	b8 1c 0a 00 00       	mov    $0xa1c,%eax
 745:	ba 1c 0a 00 00       	mov    $0xa1c,%edx
    base.s.size = 0;
 74a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 74c:	a3 18 0a 00 00       	mov    %eax,0xa18
    base.s.size = 0;
 751:	b8 1c 0a 00 00       	mov    $0xa1c,%eax
    base.s.ptr = freep = prevp = &base;
 756:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
    base.s.size = 0;
 75c:	89 0d 20 0a 00 00    	mov    %ecx,0xa20
