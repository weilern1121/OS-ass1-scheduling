...
main(int argc, char *argv[])
{
  ...
  20:	b8 90 07 00 00       	mov    $0x790,%eax
  25:	ba 92 07 00 00       	mov    $0x792,%edx
  ...
  4b:	c7 44 24 0c 97 07 00 	movl   $0x797,0xc(%esp)
  52:	00 
  53:	8b 44 b7 fc          	mov    -0x4(%edi,%esi,4),%eax
  57:	c7 44 24 04 92 07 00 	movl   $0x792,0x4(%esp)
  5e:	00 
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 99 07 00 00       	mov    $0x799,%eax
...
free(void *ap)
{
 ...
 611:	a1 30 0a 00 00       	mov    0xa30,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 68c:	8b 4b fc             	mov    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 68f:	a3 30 0a 00 00       	mov    %eax,0xa30
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 707:	76 37                	jbe    740 <malloc+0x90>
    ...
    if(p == freep)
 709:	39 05 30 0a 00 00    	cmp    %eax,0xa30
 ...
 729:	e8 e2 fe ff ff       	call   610 <free>
  return freep;
 72e:	8b 15 30 0a 00 00    	mov    0xa30,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 764:	eb e9                	jmp    74f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 766:	b8 34 0a 00 00       	mov    $0xa34,%eax
 76b:	ba 34 0a 00 00       	mov    $0xa34,%edx
    base.s.size = 0;
 ...
 772:	a3 30 0a 00 00       	mov    %eax,0xa30
    base.s.size = 0;
 777:	b8 34 0a 00 00       	mov    $0xa34,%eax
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 77c:	89 15 34 0a 00 00    	mov    %edx,0xa34
    base.s.size = 0;
 782:	89 0d 38 0a 00 00    	mov    %ecx,0xa38
